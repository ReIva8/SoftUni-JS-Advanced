function carFactory(wantedCar) {
    ...
    return {
        ...
        engine: engines.filter( e => e.power >= wantedCar.power) [0], // [0] because it finds the first engine that corresponds to the required engine power, so it takes element at index 0
